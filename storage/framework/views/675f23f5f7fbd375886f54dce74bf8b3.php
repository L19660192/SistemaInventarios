            ...
            <tbody>
                <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($usuario->n_documento); ?></td>
                        <td><?php echo e($usuario->nombre); ?> <?php echo e($usuario->apellidos); ?></td>
                        ...
                        <td>
                            ...
                            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modalEditar"
                                data-id="<?php echo e($usuario->usuario_id); ?>">Editar</button>
                            <!-- Botón Eliminar -->
                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modalEliminar"
                                data-id="<?php echo e($usuario->usuario_id); ?>">Eliminar</button>
                        </td>
                    </tr>
    ...
    <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('usuarios.eliminar', ':id')); ?>" method="POST" id="formEliminar">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\franm\Herd\prub\resources\views/usuarios/listar.blade.php ENDPATH**/ ?>